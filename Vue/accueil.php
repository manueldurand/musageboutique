<section><div class="bandeau-mobile mobile titre centre">
   ...
   BIENVENUE
    ...
    <div class="mobile image-accueil">
        <img src="assets/img/comp/fleuriste-boutique.png" alt="fleuriste devant sa boutique">
    </div>
    <div id="annonce">
        <p id="annonce-texte">Loterie spéciale 'Fête des mères' ... des cadeaux originaux à gagner pour toute commande ...
          des stylos “Lafleur”  ...
    ...
    <a href="index.php?uc=boutique&action=tousLesProduits"><div class="mobile btn-accueil-mobile marge-25">
        <button class="btn centre ">
            voir la boutique
        </button>
    </div></a>
</section>